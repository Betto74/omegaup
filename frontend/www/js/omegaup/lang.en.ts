...
const translations: { [key: string]: string; } = {
  ...
  problemCreatorGenerateInput: "Generate input",
  ...
  problemCreatorTruncatedWarning: "Please note that the input or output content is truncated. Editing is disabled to avoid memory overload",
